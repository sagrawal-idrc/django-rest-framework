...
__Note:__ when you set new permission classes through class attribute or decorators you're telling the view to ignore `DEFAULT_PERMISSION_CLASSES` set in __settings.py__ file.
